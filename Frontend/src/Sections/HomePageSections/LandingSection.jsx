...
function LandingSection() {
  return (
    ...
    <div className='w-full min-h-[100vh] py-8 flex items-center justify-between'>
        <div className='px-10 space-y-10 md:px-20 lg:px-32'>
            <img src={logo} alt="EstiMotor" className='w-52 drop-shadow-[#000000]' />
            <h1 className='text-[2.6rem] leading-tight font-semibold drop-shadow-2xl'>Accelerate with<br/>Confident Pricing</h1>
